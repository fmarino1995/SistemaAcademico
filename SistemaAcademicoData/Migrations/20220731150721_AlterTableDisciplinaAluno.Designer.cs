...
namespace SistemaAcademicoData.Migrations
{
    ...
    [Migration("20220731150721_AlterTableDisciplinaAluno")]
    partial class AlterTableDisciplinaAluno
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.NotaAluno", b =>
                {
                    b.Property<int>("NotaAlunoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("NotaAlunoId"), 1L, 1);

                    b.Property<int>("DisciplinaAlunoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.NotaAluno", b =>
                {
                    b.HasOne("Domain.Entities.DisciplinaAluno", "DisciplinaAluno")
                        .WithMany()
                        .HasForeignKey("DisciplinaAlunoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("DisciplinaAluno");
                });
